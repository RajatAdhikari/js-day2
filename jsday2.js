...
//                 }
//                 outer();
// - in above example inner function is accessing to the value of a variable of the outer function 
...
//                 }
//                 var innerFunc=OuterFunction('nitin');
//                 innerFunc('welcome');
// -As per the above code, InnerFunction() has access to the variables in the OuterFunction()
...
//     -example:
//             var car1 = { name: "audi", color: "white" };
//             var car2 = { name: "benz", color: "black" };
//             function model(message1, message2) {
//             console.log(message1 + " " + this.name + " " + message2 + ", " +this.color );
//             }
//             model.call(car1, "my", "is"); // my audi is white
//             model.call(car2, "my", "is"); // my benz is black
...
//             console.log(message1 + " " + this.name + " " + message2 + ", " +this.color );
//             }
//             model.apply(car1,["my","is"]); // my audi is white
//             model.apply(car2,["my","is"]); // my benz is black
//     3)bind: returns a new function, allowing you to pass any number of arguments.and this new function we can call it anytime and anywhere
//     -example:
//             var car1 = { name: "audi", color: "white" };
//             var car2 = { name: "benz", color: "black" };
//             function model(message1, message2) {
//             console.log(message1 + " " + this.name + " " + message2 + ", " +this.color );
//             }
//             let newModel= model.bind(car1);
//             let newMode2= mode2.bind(car2);
//             newModel("my","is");//my audi is white
//             newMode2("my","is");//my benz is black
...
//                 console.log(parentObject.name);//maharaj
//                 console.log(childObect.name);//maharaj
...
// -example-
//             setTimeout(function(){
//                 console.log('morning');//output will print after 2 sec
//             },2000)
...
//                 let a='hii';
//                 let b='bye';
//                 console.log(a);//first print//synch
//                 setTimeout(function(){
//                     console.log(b);//third print//asynchronous
//                 },2000);
//             }
//             my()
//             console.log('nk');//second prints//synch
